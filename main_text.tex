...
As a result, populations of peripheral clocks are likely synchronized by common external cues, with stochastic effects and cell heterogeneity driving entrained populations to gradually desynchronize.
...
\begin{figure}[tbp]
  \begin{center}
    ...
    \caption{
{\bfseries Synchrony effects population-level amplitude.}
...
Each cell in the population is subjected to a $20\%$ increase in the $\mathit{vtp}$ parameter for $d=\nicefrac{\pi}{2}$, inducing both a phase and amplitude change.
...
The first pulse desynchronizes the system, while the second resynchronizes.
