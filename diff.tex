...
%DIF DEL /dev/fd/63      Fri Aug 29 11:22:01 2014
%DIF ADD main_text.tex   Fri Aug 29 11:21:56 2014
...
\begin{figure}[tbp]
  \begin{center}
    ...
    \caption{
{\bfseries Synchrony \DIFdelbeginFL \DIFdelFL{effects }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{affects }\DIFaddendFL population-level amplitude.}
...
Each cell in the population is subjected to a $20\%$ increase in the $\mathit{vtp}$ parameter \DIFaddbeginFL \DIFaddFL{(}{\itshape \DIFaddFL{Per}} \DIFaddFL{transcription rate) }\DIFaddendFL for $d=\nicefrac{\pi}{2}$, inducing both a phase and amplitude change.
...
\DIFdelbeginFL \DIFdelFL{The }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Circadian oscillations are suppressed by the }\DIFaddendFL first \DIFaddbeginFL \DIFaddFL{light }\DIFaddendFL pulse \DIFdelbeginFL \DIFdelFL{desynchronizes the system, while }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{and rescued by }\DIFaddendFL the second\DIFdelbeginFL \DIFdelFL{resynchronizes}\DIFdelendFL .
